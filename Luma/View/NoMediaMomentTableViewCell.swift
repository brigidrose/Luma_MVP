...
//  Luma
//
//  Created by Chun-Wei Chen on 6/21/16.
//  Copyright © 2016 Luma Legacy. All rights reserved.
//

import UIKit

class NoMediaMomentTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        let labelsV = NSLayoutConstraint.constraintsWithVisualFormat("V:|-30-[actionLabel]-25-[contentLabel]->=14-|", options: [.AlignAllLeft, .AlignAllRight], metrics: metricsDictionary, views: viewsDictionary)
