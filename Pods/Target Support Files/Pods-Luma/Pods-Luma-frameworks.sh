...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Luma/CountdownLabel.framework"
  install_framework "Pods-Luma/DateTools.framework"
  install_framework "Pods-Luma/DynamicColor.framework"
  ...
  install_framework "Pods-Luma/LTMorphingLabel.framework"
  install_framework "Pods-Luma/MarqueeLabel.framework"
  install_framework "Pods-Luma/NVActivityIndicatorView.framework"
  install_framework "Pods-Luma/Parse.framework"
  install_framework "Pods-Luma/ParseFacebookUtilsV4.framework"
  install_framework "Pods-Luma/QBImagePickerController.framework"
  ...
  install_framework "Pods-Luma/SwiftyJSON.framework"
